...
//==========
CData/*0:0*/ Vrv32i_cpu_t::__Vtable1_rv32i_cpu_t__DOT__write_rd[64];
CData/*3:0*/ Vrv32i_cpu_t::__Vtable2_rv32i_cpu_t__DOT__mask[32];
...
VL_INLINE_OPT void Vrv32i_cpu_t::_sequent__TOP__1(Vrv32i_cpu_t__Syms* __restrict vlSymsp) {
    ...
    Vrv32i_cpu_t* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Variables
    CData/*0:0*/ __Vdlyvset__rv32i_cpu_t__DOT__X__v0;
    CData/*1:0*/ __Vdly__rv32i_cpu_t__DOT__phi;
    CData/*0:0*/ __Vdlyvset__rv32i_cpu_t__DOT__X__v1;
    CData/*4:0*/ __Vdlyvdim0__rv32i_cpu_t__DOT__X__v2;
    CData/*0:0*/ __Vdlyvset__rv32i_cpu_t__DOT__X__v2;
    CData/*4:0*/ __Vdlyvdim0__rv32i_cpu_t__DOT__X__v3;
    CData/*0:0*/ __Vdlyvset__rv32i_cpu_t__DOT__X__v3;
    IData/*31:0*/ __Vdlyvval__rv32i_cpu_t__DOT__X__v2;
    IData/*31:0*/ __Vdlyvval__rv32i_cpu_t__DOT__X__v3;
    // Body
    ...
    vlTOPp->rv32i_cpu_t__DOT__rd = (0x1fU & (vlTOPp->rv32i_cpu_t__DOT__inst 
                                             >> 7U));
    vlTOPp->rv32i_cpu_t__DOT__access_width = (((0U 
                                                == 
                                                (7U 
    ...
    vlTOPp->rv32i_cpu_t__DOT__immi = ((0xfffff800U 
                                      ...
                                      | (0x7ffU & (vlTOPp->rv32i_cpu_t__DOT__inst 
                                                   >> 0x14U)));
    vlTOPp->rv32i_cpu_t__DOT__next_pc = (((((((((0x18U 
                                                 == 
                                                 ((0xe0U 
                                                   & (vlTOPp->rv32i_cpu_t__DOT__inst 
                                                      >> 7U)) 
...
void Vrv32i_cpu_t::_settle__TOP__2(Vrv32i_cpu_t__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->rv32i_cpu_t__DOT__mask = vlTOPp->__Vtable2_rv32i_cpu_t__DOT__mask
        [vlTOPp->__Vtableidx2];
    if ((0U == (3U & vlTOPp->out_mem_addr))) {
        vlTOPp->rv32i_cpu_t__DOT__mem_in = ((1U == (IData)(vlTOPp->rv32i_cpu_t__DOT__mem_width))
                                             ? (0xffU 
                                                & vlTOPp->in_data)
                                             : ((2U 
                                                 == (IData)(vlTOPp->rv32i_cpu_t__DOT__mem_width))
                                                 ? 
                                                (0xffffU 
                                                 & vlTOPp->in_data)
                                                 : vlTOPp->in_data));
        ...
        if ((1U == (3U & vlTOPp->out_mem_addr))) {
            vlTOPp->rv32i_cpu_t__DOT__mem_in = ((1U 
                                                 == (IData)(vlTOPp->rv32i_cpu_t__DOT__mem_width))
                                                 ? 
                                                (0xffU 
                                                 & (vlTOPp->in_data 
            ...
            if ((2U == (3U & vlTOPp->out_mem_addr))) {
                vlTOPp->rv32i_cpu_t__DOT__mem_in = 
                    ((1U == (IData)(vlTOPp->rv32i_cpu_t__DOT__mem_width))
                      ? (0xffU & (vlTOPp->in_data >> 0x10U))
                      : ((2U == (IData)(vlTOPp->rv32i_cpu_t__DOT__mem_width))
                          ? (0xffffU & (vlTOPp->in_data 
                                        >> 0x10U)) : 0U));
            } else {
                if ((3U == (3U & vlTOPp->out_mem_addr))) {
                    vlTOPp->rv32i_cpu_t__DOT__mem_in 
